...
public class EmpInfoDriver
{
	public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException
	{
		...
		FileInputFormat.addInputPath(job, new Path("/home/sanidhya/Data/CTC/employee_ctc_data.txt"));
		FileOutputFormat.setOutputPath(job, new Path("/home/sanidhya/output/CTC-out-02"));
